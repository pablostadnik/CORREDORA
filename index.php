    ...
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          ...
          <h2><span><?php echo $pro[0]["titulo"]; ?></span></h2>
          <p class="infopost">Subido <span class="date"><?php echo $pro[0]["fecha"];?></span> por <a href="#">Diego Buffarini</a> &nbsp;&nbsp;|&nbsp;&nbsp; Filed under <a href="#">templates</a>, <a href="#">internet</a> &nbsp;&nbsp; <a href="#" class="com">Comments <span>11</span></a></p>
          <div class="clr"></div>
          <?php $ruta="images/".$pro[0]["rutaimg"]; ?>
          <div class="img" style ="padding:15px 15px 0px 0px;"><img src="<?php echo $ruta ?>"  width="250" height="154" alt="" class="fl" /></div>
          <div class="post_content">
            <p><?php echo utf8_decode($pro[0]["descripcion"]);?>
        ...
        <div class="article">
          <h2><span><?php echo $pro[1]["titulo"]; ?></span> </h2>
          <p class="infopost">Subido<span class="date"><?php echo $pro[1]["fecha"];?></span> por <a href="#">Diego Buffarini</a> &nbsp;&nbsp;|&nbsp;&nbsp; Filed under <a href="#">templates</a>, <a href="#">internet</a> &nbsp;&nbsp; <a href="#" class="com">Comments <span>7</span></a></p>
          <div class="clr"></div>
           <?php $ruta="images/".$pro[1]["rutaimg"]; ?>
          <div class="img"style ="padding:15px 15px 0px 0px;"><img src="<?php echo $ruta ?>" width="" height="154" alt="" class="fl" /></div>
          <div class="post_content">
            <p><p><?php echo utf8_decode($pro[1]["descripcion"]);?></p>
            
          </div>
          <div class="clr"></div>
        </div>
        <p class="pages"><small>Page 1 of 3</small> <span>1</span> <a href="index2.php">2</a>  <a href="index2.php">&raquo;</a></p> 
      </div>
      <div class="sidebar">
