    ...
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          ...
          <h2><span><?php echo $pro[2]["titulo"]; ?></span></h2>
          <p class="infopost">Subido <span class="date"><?php echo $pro[2]["fecha"];?></span> por <a href="#">Diego Buffarini</a> &nbsp;&nbsp;|&nbsp;&nbsp; Filed under <a href="#">templates</a>, <a href="#">internet</a> &nbsp;&nbsp; <a href="#" class="com">Comments <span>11</span></a></p>
          <div class="clr"></div>
          <?php $ruta="images/".$pro[2]["rutaimg"]; ?>
          <div class="img" style ="padding:15px 15px 0px 0px;"><img src="<?php echo $ruta ?>"  width="250" height="154" alt="" class="fl" /></div>
          <div class="post_content">
            <p><?php echo utf8_decode($pro[2]["descripcion"]);?>
        ...
        <div class="article">
          <h2><span><?php echo $pro[3]["titulo"]; ?></span> </h2>
          <p class="infopost">Subido<span class="date"><?php echo $pro[3]["fecha"]; ?></span> por <a href="#">Diego Buffarini</a> &nbsp;&nbsp;|&nbsp;&nbsp; Filed under <a href="#">templates</a>, <a href="#">internet</a> &nbsp;&nbsp; <a href="#" class="com">Comments <span>7</span></a></p>
          <div class="clr"></div>
           <?php $ruta="images/".$pro[3]["rutaimg"]; ?>
          <div class="img"style ="padding:15px 15px 0px 0px;"><img src="<?php echo $ruta ?>" width="" height="154" alt="" class="fl" /></div>
          <div class="post_content">
            <p><?php echo utf8_decode($pro[3]["descripcion"]); ?></p>
            
          </div>
          <div class="clr"></div>
        </div>
        <p class="pages"><small>Page 2 of 3</small> <a href="index.php">1</a> <span>2</span>   <a href="index3.php">&raquo;</a></p> 
      </div>
      <div class="sidebar">
