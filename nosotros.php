...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div id ="presentacion">
      <IMG SRC="images/cosechadora1.jpg" style="width:600px;height:300px;"></br></br></br>
        <p style="width:600px;font: oblique 200% sans-serif bold; "> Una empresa creada con la intencion de ser una alternativa o solucion para el productor, en estos tiempos, en los cuales no es nada facil sobrevivir a tantas trabas impuestas al sector agropecuario.</br>
        Nuesta misión principal es ascesorar a pequeños y grandes productores para mantenerlos vigentes con una participación destacada en el mercado de granos, aportando confiabilidad y valor para el mercado y sus partes.</p>
      </div>
      <div class="sidebar" style="position: relative; bottom: 610px;">
